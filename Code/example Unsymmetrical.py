...
def main():
    ...
    y_2 = eData.getSol(5, specialFamily="5B - IceWaterSnowLandWaterIce")
    x_2 = n.linspace(-6, 6, y_2.shape[0])

    fig, ax = plt.subplots(1, 1, figsize=(6, 3))

    ax.plot(x_1, y_1, label=r'$T_{5A}(x)$',  zorder=1, c='coral')
    ax.plot(x_2, y_2, label=r'$T_{5B}(x)$', zorder=1, c='dodgerblue')

    ax.plot(x_1, y_1[::-1], label=r'$T_{5A}(-x)$',  zorder=2, ls=(0, (1, 4)), c='coral')
    ax.plot(x_2, y_2[::-1], label=r'$T_{5B}(-x)$', zorder=2, ls=(0, (1, 4)), c='dodgerblue')
