...
def main():
    ...
    def update():
        ...
        if fSim.getResultFirst():
            ...
            ax[0, 0].plot(x, data[0, 1:], c='deepskyblue', ls='-.', label='Finite difference')
            ax[0, 0].legend()
            ax[0, 1].set_title(f't={fSim.times[0, 1]}')
            ax[0, 1].plot(x, data[333, 1:], c='deepskyblue', ls='-.', label='Finite difference')
            ax[0, 1].legend()
            ax[1, 0].set_title(f't={fSim.times[1, 0]}')
            ax[1, 0].plot(x, data[667, 1:], c='deepskyblue', ls='-.', label='Finite difference')
            ax[1, 0].legend()
            ax[1, 1].set_title(f't={fSim.times[1, 1]}')
            ax[1, 1].plot(x, data[1000, 1:], c='deepskyblue', ls='-.', label='Finite difference')
            ax[1, 1].legend()
            plt.tight_layout()
            fig.canvas.draw()
        ...
        if sSim.getResultFirst():
            ...
            ax[0, 0].set_title(f't={fSim.times[0, 0]}')
            ax[0, 0].plot(x, data[0, 1:], c='darkorange', ls='--', label='Spectral')
            ax[0, 0].legend()
            ax[0, 1].set_title(f't={fSim.times[0, 1]}')
            ax[0, 1].plot(x, data[333, 1:], c='darkorange', ls='--', label='Spectral')
            ax[0, 1].legend()
            ax[1, 0].set_title(f't={fSim.times[1, 0]}')
            ax[1, 0].plot(x, data[667, 1:], c='darkorange', ls='--', label='Spectral')
            ax[1, 0].legend()
            ax[1, 1].set_title(f't={fSim.times[1, 1]}')
            ax[1, 1].plot(x, data[1000, 1:], c='darkorange', ls='--', label='Spectral')
            ax[1, 1].legend()
            plt.tight_layout()
            fig.canvas.draw()
